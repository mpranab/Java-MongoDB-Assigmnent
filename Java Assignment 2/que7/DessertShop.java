...
public class DessertShop {
	...
	public static void main(String[] args) {
		...
		switch (choose) {
		case 1:
			System.out.println("Add Dessert Items.");
			break;
		case 2:
			...
			switch (chooseDI) {
			case 1:
				System.out.println("Enter amount(Dollars):");
				int amt1 = sc.nextInt();
				DessertItem cn = new Candy();
				cn.getCost(amt1);
				break;
			case 2:
				System.out.println("Enter amount(Euros):");
				int amt2 = sc.nextInt();
				DessertItem co = new Cookie();
				co.getCost(amt2);
				break;
			case 3:
				System.out.println("Enter amount(Rupees):");
				int amt3 = sc.nextInt();
			...
			break;
		default:
			System.out.println("Invalid Item Caught");
		}
	}
}
